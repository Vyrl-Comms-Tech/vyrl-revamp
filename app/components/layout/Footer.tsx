            ...
            <div className="footer-connect-row">
                ...
                <div className="footer-connect-left">
                    <div className="footer-connect-heading">
                        ...
                        <button className="footer-arrow-btn footer-arrow-btn--left" aria-label="Connect">
                        ...
                        <button className="footer-arrow-btn footer-arrow-btn--right" aria-label="Connect">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 18" fill="none">
                                <path
                                    d="M1.00005 16.9606L13.0528 1.00031M14.9171 11.8065L13.0528 1.00031L2.14891 2.16431"
                                    stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
            ...
            <div className="footer-bottom-row">
                ...
                <div className="footer-subscribe">
                    ...
                    <p className="footer-subscribe-subtitle">
                        Stay updated with the latest news, insights, and updates from Vyrl—delivered
                        straight to your inbox.
                    </p>
                    <div className="footer-subscribe-form">
                        <input type="email" placeholder="Subscribe" className="footer-subscribe-input" />
                ...
                <div className="footer-mascot">
                    <video className='' autoPlay muted loop playsInline src="/smiley.mp4"></video>
                </div>
